...
<%
    ...
    session.setAttribute("page", "vendor_blog");
    ...
    ResultSet rs = getCon().createStatement().executeQuery("Select* from vendor_blog where vendor_id='" + id + "' and service_id='" + service + "'");
    while (rs.next()) {

        String data[] = new String[8];

        data[0] = rs.getString("post_id");
        data[1] = rs.getString("date");
        data[2] = rs.getString("time");
        data[3] = rs.getString("title");
        data[4] = rs.getString("content");
        data[5] = rs.getString("image_url");
        data[6] = rs.getString("comments");
        data[7] = rs.getString("likes");

        list.add(data);

    }

    ResultSet rs1 = getCon().createStatement().executeQuery("Select company_name from vendor where vendor_id='" + id + "'");
    if (rs1.first()) {
...
<html dir="ltr" lang="en">
    ...
    <body class="has-side-panel side-panel-left fullwidth-page">
        ...
        <div id="wrapper" class="clearfix">
                ...
                <section class="inner-header divider parallax layer-overlay overlay-dark-5" data-bg-img="images/bg/bg11.jpg">
                    <div class="container pt-120 pb-50">
                        ...
                        <div class="section-content pt-0">
                            <div class="row"> 
                                <div class="col-md-12">
                                    <h3 class="title text-white"><%=company_name + " - "%>News Blog</h3>
                                </div>
                            </div>
                        </div>
                    </div>
                                                    ...
                                                    <article class="post clearfix">
                                                        <div class="entry-header">
                                                            ...
                                                            <div class="dropdown">
                                                                ...
                                                                <ul class="dropdown-menu">
                                                                    ...
                                                                    <li><a href="" onclick="delete_post(<%=fields[0]%>, 'vendor'); return false;">Delete Post</a></li>
                                                            ...
                                                            <ul class="list-inline font-12 mb-20 mt-10">
                                                                <li>posted by <a href="#" class="text-theme-colored"><%=session.getAttribute("first_name")%></a></li>
                                                        ...
                                                        <div class="entry-content">
                                                            ...
                                                            <ul class="list-inline like-comment pull-left font-12">
                                                                ...
                                                                <li><a id="<%=fields[0]%>" href="" onclick="update_like(<%=fields[0]%>, 'vendor',<%=fields[7]%>); return false;"><i class="pe-7s-like2"></i><%=fields[7]%></a></li>
                                                            </ul>
                                                            <a id="view<%=fields[0]%>" class="pull-right text-gray font-13" href="" onclick="view_comments(<%=fields[0]%>, 'vendor'); return false;"><i class="fa fa-angle-double-right text-theme-colored"></i>View All Comments</a>
                                                        </div>
                                                        <input id="text<%=fields[0]%>" class="form-control" onkeypress="update_comment(<%=fields[0]%>, 'vendor', event)" placeholder="Write a comment..."/>
                                                    </article>
                                                </div>
                                            </li>
                                            <%}%>
            ...
            <input id="service_id" type="hidden" value="<%=service%>"/>
