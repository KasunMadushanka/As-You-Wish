<%
    ...
    ResultSet rs;
    String text = "";
    rs = getCon().createStatement().executeQuery("SELECT * FROM `website` WHERE `title` = 'terms and conditions' ");
    while(rs.next()){
                                    ...
                                    <div class="panel panel-inverse" data-sortable-id="form-wysiwyg-2">
                                        ...
                                        <div class="panel-heading">
                                            ...
                                            <div class="row" style="padding-bottom:10px;">
                                                <button type="submit" id="legal" name="terms" class="btn btn-primary"><i class="fa fa-pencil-square-o"></i>  Update </button><br>	
                                            </div>
                                        </div>
