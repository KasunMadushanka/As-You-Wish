...
<body>
	...
	<div id="page-container" class="fade page-sidebar-fixed page-header-fixed">
		...
		<div id="content" class="content">
			...
			<!-- end breadcrumb -->
			<!-- begin page-header -->
			<h1 class="page-header">All Vendor Details <small></small></h1>
			<!-- end page-header -->
                                    ...
                                    <%
                                        ...
                                        while(rs.next()){ //`first_name`, `last_name`, `email`, `company_name`
                                            ...
                                            if(Statuus.equals("active") ){
                                                btn = "<button type='submit'  name='editCat' class='btn btn-danger btn-sm' ><i class='fa fa-close'></i> Deactivate the Vendor </button>";
                                                changeStat = "deactivate"; 
                                            }
                                            else{
                                                btn = "<button type='submit'  name='editCat' class='btn btn-success btn-sm' ><i class='fa fa-check'></i> Activate the Vendor </button>";
                                                changeStat = "active";
                                            }
                                       %>
                                            <tr class="odd gradeX">
                                                ...
                                                <td> 
                                                    <form  method="post">
                                                        <input type="hidden" id="txt" name="txt" value="<%= rs.getString("vendor_id") %>">
...
<%
        ...
        if(request.getParameter("editCat") != null){ 
            ...
            int i2=stx.executeUpdate("update vendor set status = '"+Type+"' where vendor_id = '"+ Vid +"'");
            
            if(i2 == 1){
                out.print("<script>swal({  title: 'Done!', text: '', type: 'success', confirmButtonText: 'Done!'}, function(){ window.location.href='vendors.jsp'; });</script>");
