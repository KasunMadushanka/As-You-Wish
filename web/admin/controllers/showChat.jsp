    ...
    <body>
        <ul class="chats">
            ...
            <li class="right">
                ...
                <a href="javascript:;" class="image"><img alt="" src="assets/img/profile/user-4.jpg" class="img-circle" width="50" height="50"></a>
                <div class="message">
                    <%= rs3.getString("msg")%>
                </div>
            </li>
            ...
            <li class="left">
                ...
                <a href="javascript:;" class="image"><img alt="" src="../<%= uImg%>" class="img-circle" width="50" height="50" /></a>
                <div class="message">
                    <%= rs3.getString("msg")%>
                </div>
            </li>
