...
<%
    ...
    ResultSet rs;
    String sql = "SELECT *,SUBSTRING_INDEX(SUBSTRING_INDEX( `date` , ' ', 1 ),' ',1) AS b FROM `poders` WHERE `itemId` = '"+id+"' order by `date`";
	...
	<div id="page-container" class="fade page-sidebar-fixed page-header-fixed">
		...
		<div id="content" class="content">
			...
			<ol class="breadcrumb pull-right">
				...
				<li class="active">Purchase Order Results</li>
			</ol>
			<!-- end breadcrumb -->
			<!-- begin page-header -->
