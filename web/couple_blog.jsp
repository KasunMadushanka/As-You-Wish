...
<%
    ...
    session.setAttribute("page", "couple_blog");

    ArrayList list = new ArrayList();

    ResultSet rs = getCon().createStatement().executeQuery("Select* from couple_blog where customer_id='" + id + "'");
    while (rs.next()) {
                ...
                <section class="inner-header divider parallax layer-overlay overlay-dark-5" data-bg-img="images/bg/bg11.jpg">
                    <div class="container pt-120 pb-50">
                        ...
                        <div class="section-content pt-0">
                            <div class="row"> 
                                <div class="col-md-12">
                                    <h3 class="title text-white">Our Story</h3>
                                </div>
                            </div>
                        </div>
                    </div>
