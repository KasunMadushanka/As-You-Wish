...
<html dir="ltr" lang="en">
    ...
    <head>
        ...
        <script src="myjs/customer_sign_up.js"></script>
                ...
                <section class="inner-header divider parallax layer-overlay overlay-dark-5" data-bg-img="images/bg/bg11.jpg">
                    <div class="container pt-120 pb-50">
                        ...
                        <div class="section-content pt-0">
                            <div class="row"> 
                                <div class="col-md-12">
                                    <h3 class="title text-white">Customer Registration</h3>
                                </div>
                            </div>
                        </div>
                    </div>
                                        ...
                                        <div>
                                            ...
                                            <div class="row">
                                                <div class="form-group col-md-6">
                                                    ...
                                                    <input id="partner_first_name" name="partner_first_name" class="form-control" type="text">
                                                </div>
                                                <div class="form-group col-md-6">
                                                    <label for="partner_last_name"><b>Partner's Last Name*</b></label>
                                                    <input id="partner_last_name" name="partner_last_name" class="form-control" type="text">
                                                </div>
                                            </div>
                                            <div class="row">
                                                <div class="form-group col-md-6">
                                                    <label for="mobile"><b>Mobile (+94)*</b></label>
                                                    <input id="mobile" name="mobile" class="form-control" onkeypress="check_mobile(event)" type="text">
                                                </div>
                                                <div class="form-group col-md-6">
                                            ...
                                            <div class="row">
                                                <div class="form-group col-md-6">
                                                    ...
                                                    <input id="address1" name="address1" class="form-control" placeholder="Street address" type="text">
                                                </div>
                                                <div class="form-group col-md-6">
                                                    <label for="address2"><b>Address Line 2</b></label>
                                                    <input id="address2" name="address2" class="form-control" placeholder="Apartment (optional)" type="text">
                                                </div>                         
                                            </div>
                                            <div class="row">
                                                <div class="form-group col-md-6">
                                            ...
                                            <div class="form-group">
                                                <button id="sign_up_button" type="button" class="btn btn-dark btn-theme-colored btn-block mt-15">Sign Up</button>
                                            </div>
                                        </div>
                                    </div>
                                </div>
